<div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid min-h-full max-w-lg grid-cols-5 mx-auto">
        <x-nav-link-gin wire:navigate  href="{{ route('gincana.index') }}" :active="request()->routeIs('gincana.index')" data-tooltip-target="tooltip-home"  >
            <svg class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <x-nav-link-gin wire:navigate href="{{ route('gincana.agenda') }}" :active="request()->routeIs('gincana.agenda')" data-tooltip-target="tooltip-calendar" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-red-600 dark:group-hover:text-red-500">
        ...
        <div class="flex items-center justify-center">
            <a wire:navigate href="{{ route('gincana.tblpontos') }}" :active="request()->routeIs('gincana.tblpontos')" data-tooltip-target="tooltip-new" type="button" class="inline-flex items-center justify-center w-10 h-10 font-medium rounded-full hover:bg-yellow-700 group focus:ring-4 focus:ring-yellow-800 focus:outline-none dark:focus:ring-yellow-800">
