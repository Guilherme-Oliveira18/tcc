<x-app-layout title="Historia">
    <div class="justify-center py-10 mx-auto my-2 align-items-center">
        ...
        <head>
            ...
            <style>
                ...
                #progress-bar-container li:hover:before {
                    ...
                    background: linear-gradient(to right, #e91e2c 0%, #fff 100%);
                }
        ...
        <body>
            ...
            <div class="w-full flex flex-row text-center justify-center items-center">
                <h1
                    class="text-3xl sm:text-5xl font-bold bg-clip-text pb-4 md:pb-6 bg-gradient-to-r from-yellow-600 to-red-600">
                    Linha do Tempo</h1>
            </div>
            <br>
