...
<div>
    ...
    <div class="w-full flex items-center flex-wrap justify-center py-4 px-20 text-lg text-center">
        ...
        <p>Formado por cinco integrantes, a empresa New Wave tem como objetivo a proposta de um site que ajudará a Etec
            ...
            local de estudo e a se adaptar as suas origens, sendo isso em um site de fácil acesso e uso.<br>
    ...
    <h2 class="mt-14 text-2xl md:text-3xl font-bold text-center lg:text-5xl">Conheça nossa equipe</h2>
    <section class="container mx-auto py-36 px-8 justify-items-center">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
            ...
            <!--TERCEIRO-->
            <div class="shadow-lg rounded-lg relative overflow-hidden group h-5/6">
                <img class="rounded-lg"
            ...
            <!--QUINTO-->
            <div class="shadow-lg rounded-lg relative overflow-hidden group h-5/6">
                <img class="rounded-lg" src="{{ asset('storage/profile-photos/' . 'guizinho.jpeg') }}"
                    alt="Team Section">
                <div
                    class=" absolute bg-black bg-opacity-75  group-hover:translate-x-0 -translate-x-full rounded-lg top-0 left-0 w-full h-full flex items-center
                    justify-center duration-300">
