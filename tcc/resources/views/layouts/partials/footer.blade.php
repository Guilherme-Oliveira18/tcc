            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="flex flex-wrap items-top mb-6">
                    <div class="w-full lg:w-4/12 px-4 ml-auto">
                        <span class="block uppercase text-white text-sm font-semibold mb-2">Nossos links</span>
                        <ul class="list-unstyled">
                            <li>
                                <a class="text-black hover:text-white font-semibold block pb-2 text-sm"
                                    href="/sobre">Sobre nós</a>
                            </li>
                            <li>
                                <a class="text-black hover:text-white font-semibold block pb-2 text-sm"
                                    href="/gincana">Gincana</a>
                            </li>
                            <li>
                                <a class="text-black hover:text-white font-semibold block pb-2 text-sm"
                                    href="/blog">Explorar</a>
                            </li>
                            <li>
                                <a class="text-black hover:text-white font-semibold block pb-2 text-sm"
                                    href="/login">Login</a>
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        <span class="block uppercase text-white text-sm font-semibold mb-2">Outros
                            Recursos</span>
                        <ul class="list-unstyled">
                            <li>
                                <a class="text-black hover:text-white font-semibold block pb-2 text-sm"
                                    href="terms-of-service">Termos &amp; Condições</a>
                            </li>
                            <li>
                                <a class="text-black hover:text-white font-semibold block pb-2 text-sm"
                                    href="/privacy-policy">Política de Privacidade</a>
                            </li>
                            <li>
                                <a class="text-black hover:text-white font-semibold block pb-2 text-sm"
                                    href="mailto:new.wave.sorocaba@gmail.com">Contate-nos</a>
                            </li>
                        </ul>
                    </div>
                </div>
